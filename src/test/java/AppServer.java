...
public class AppServer {
     ...
     * zookeeper中集群服务器的总节点
     */
    private String groupNode = "spider_cluster";
    ...
    public void connectZookeeper(String zookeeperServerHost, String serverName)
        ...
        zooKeeper = new ZooKeeper(zookeeperServerHost, 30000, new Watcher() {
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if (data.length > 7) {
                            FileUtil.writeFile(data, "d:\\", serverNodePath + "-sites.zip");
                        }
    ...
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        ...
        appServer.connectZookeeper("192.168.0.50:2181", serverName);
        while (true) {
